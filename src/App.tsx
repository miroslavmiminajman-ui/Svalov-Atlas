...
export default function App() {
  ...
  // Auto Scroll detail card into view on small devices when muscle is updated
  useEffect(() => {
    if (selectedMuscleId && window.innerWidth < 1024) {
      const element = document.getElementById(`detail-${selectedMuscleId}`);
      if (element) {
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full p-4 sm:p-6 flex flex-col gap-6 relative z-10">
        ...
        {!isComparing && activeTab === 'atlas' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            {/* LEFT CONTAINER (lg:col-span-8) - holds Sidebar, Interactive Anatomy Model and Methodical stretch training card underneath */}
            <div className="lg:col-span-8 flex flex-col gap-6">
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                
                {/* COLUMN 1: SIDEBAR SEARCH, FILTERS & MUSCLE LIST */}
                <section className="flex flex-col gap-4 h-full md:max-h-[665px] bg-[#0F0F11] border border-[#27272A] rounded-2xl p-4 sm:p-5 shadow-xl">
              ...
              {/* METHODICAL DETAIL CARD (STRETCHING & STRENGTHENING) DISPLAYED HORIZONTALLY UNDER BOTH COLUMNS */}
              {currentMuscle ? (
            ...
            {/* COLUMN 3: SELECTED MUSCLE DETAILED REPORT (lg:col-span-4) */}
            <section className="lg:col-span-4 lg:sticky lg:top-4">
              {currentMuscle ? (
                ...
                <div className="bg-[#0F0F11] border border-[#27272A] rounded-2xl p-8 text-center text-[#71717A] flex flex-col items-center justify-center gap-2 min-h-[300px]">
